...
export const SPRINTS = [
  {
    ...
    status: 'completed' as SprintStatus, progress_percent: 100,
...
export const TASKS: Task[] = [
  ...
  { id:'s1-09', sprint_id:'sp-1', epic_code:'E01', sort_order:9,  assignee_code:'ba2', day_label:'T4 22/4',      type:'test',   status:'done',        priority:'critical', title:'Test case: Auth + LDAP + phân quyền vai trò',                              description:'Test: login thành công/thất bại, SSO, LDAP PTSC M&C, redirect theo role, session expiry, logout. Quyền: HR Admin/Manager/Employee thấy menu gì.' },
  { id:'s1-10', sprint_id:'sp-1', epic_code:'E02', sort_order:10, assignee_code:'ba2', day_label:'T5 23/4',      type:'test',   status:'done',        priority:'critical', title:'Test case: CRUD nhân viên + import + hiển thị trường theo vai trò',        description:'CRUD: create (success, duplicate, missing), read (filter/sort), update (partial, salary per role), soft delete. Import: valid file, mixed errors, empty file.' },
  ...
  { id:'s1-21', sprint_id:'sp-1', epic_code:'E01', sort_order:21, assignee_code:'tl',  day_label:'T6 24/4',      type:'review', status:'done',        priority:'normal',   title:'Code review + Sprint 1 demo + retrospective',                              description:'TL review: RLS policies, audit triggers, no hardcoded secrets. Demo: login 3 roles, CRUD, import, dashboard, audit trail. Retro: blockers, velocity.' },
  ...
  { id:'s3-ba2-02', sprint_id:'sp-3', epic_code:'E05', sort_order:5,  assignee_code:'ba2', day_label:'T3-T4 13-14/5', type:'test',   status:'done', priority:'normal',   estimated_hours:5, title:'Regression toàn bộ app + test UI integration',                               description:'Chạy lại tất cả test Sprint 1+2. Verify: (1) Tất cả màn hình chạy real data. (2) HRM360 import → Talent Profile → 9-Box flow end-to-end. (3) Succession Map đúng. Document bugs với severity.' },
